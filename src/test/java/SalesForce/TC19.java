...
Thread.sleep(3000);	
Select dropDown1= new Select(driver.findElement(By.id("quarter_q")));
	dropDown1.selectByVisibleText("Current and Next FQ");


Select dropDown2= new Select(driver.findElement(By.id("open")));
				dropDown2.selectByVisibleText("Closed/Won Opportunities");
